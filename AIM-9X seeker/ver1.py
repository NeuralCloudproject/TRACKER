...
def draw_wing(angles):
    ...
    for possition, angle in angles.items():
        end_point = rotate_point(center, wing_possition[possition], angle)
        
        cv2.line(canvas, center, end_point, (255, 255, 255), 3)
        cv2.putText(canvas, f"{possition} : {angle : .1f} deg", (end_point[0] - 50, end_point[1] - 20),
